...
public class SelectableGroupTest {
    ...
    public void TestaddPlayerAnswer() {
        SelectableGroup sc = new SelectableGroup();

        doNothing().when(turnMock).addPlayerAnswer(optionMock);
        sc.addPlayerAnswer(turnMock, optionMock);
    }
}
