...
public final class ErrorMessage {
    // json
    public static final String INVALID_QUESTION_SCORER_ERROR = "invalid Question Scorer class";
    public static final String INVALID_QUESTION_ERROR = "invalid Question Scorer class";

    //question option size
